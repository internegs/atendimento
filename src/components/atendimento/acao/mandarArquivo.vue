                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h1 class="fs-5 text-center">
                            Enviar para
                            <span class="text-danger">{{ nomeSelecionado }}</span>
                        </h1>
                        ...
                        >
                            <img
                                v-if="extensao == 'jpg' || 'png' || 'jpeg' || 'gif' || 'webm'"
                                :src="urlMidia"
                                alt=""
                                class="img-thumbnail"
                            />
                            ...
                            <video
                                v-else-if="extensao == 'mp4' || 'avi' || '3gp'"
                                width="50%"
                                controls
                            >
                                <source
...
export default {
    ...
    methods: {
        ...
        enviaMidia() {
            ...
            api.post('/envia_midianovo/ZmlsYWRlYXRlbmRpbWVudG8=', obj)
                .then((response) => {
                    this.status = false
        ...
        async loadPdf() {
            const pdfUrl =
                'https://inzupt.com/storage/uploads/enviados/JyE0jMBEdTLfegks118ZnNyqGiY5MiUjxDOBuWZd.pdf' // Substitua pelo URL ou caminho para o seu PDF
